...
function showLabels() {
    ...
    for (var i = 0; i < NUM_PLANETS; i++) {
        ...
        var text;
        if (i == 0) {
            text = "Mercury             Velocity: " + Vec3.length(properties.velocity).toFixed(2);
        } else if (i == 1) {
            text = "Venus               Velocity: " + Vec3.length(properties.velocity).toFixed(2);
        } else if (i == 2) {
            text = "Earth               Velocity: " + Vec3.length(properties.velocity).toFixed(2);;
        } else if (i == 3) {
            text = "Mars                Velocity: " + Vec3.length(properties.velocity).toFixed(2);
        } else if (i == 4) {
            text = "Jupiter             Velocity: " + Vec3.length(properties.velocity).toFixed(2);
        } else if (i == 5) {
            text = "Saturn              Velocity: " + Vec3.length(properties.velocity).toFixed(2);
        } else if (i == 6) {
            text = "Uranus              Velocity: " + Vec3.length(properties.velocity).toFixed(2);
        } else if (i == 7) {
            text = "Neptune             Velocity: " + Vec3.length(properties.velocity).toFixed(2);
        }
        ...
        labels.push(Entities.addEntity( {
            ...
            text: text,
            lineHeight: 0.8,
            dimensions: {x: 5.0, y: 2.0, z: 1.0},
            position: Vec3.sum(planet_properties[i].position, {x: 0.0, y: 8.0, z: 2.0}),
